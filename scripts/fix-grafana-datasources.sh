...
echo ""
log "Done."
log "  1. Datasources: $GRAFANA_URL/connections/datasources"
log "  2. Dashboard:   $GRAFANA_URL/d/ai-telemetry-executive"
log "  3. Hard-refresh: Ctrl+Shift+R"
log ""
log "If panels still error, run: ./scripts/diagnose-grafana-azure.sh"
