...
# ── 7. Wait for first Prometheus scrape ───────────────────────────────────────
log "Waiting for Prometheus scrape..."
...
echo "  App logs (raw) : http://localhost:8000/telemetry/logs/raw"
echo "  JSON logs      : http://localhost:8000/telemetry/logs/json"
echo "  Health         : http://localhost:8080/healthz"
echo "  Prometheus     : http://localhost:9090"
echo "  Grafana        : http://localhost:3000  (admin / admin)"
echo "  Dashboard      : http://localhost:3000/d/ai-telemetry-executive"
