...
param(
    [Parameter(Mandatory)]
    [string]$GitHubRepo,        # e.g. "ajaykhannaus/azure-telemetry-llm"
...
Write-Host "  ACR_LOGIN_SERVER         <your ACR FQDN, e.g. acrtelemetrydevaj.azurecr.io>" -ForegroundColor White
Write-Host "  AZURE_ACR_NAME           <your ACR short name, e.g. acrtelemetrydevaj>" -ForegroundColor White
Write-Host "  ACR_PASSWORD             <az acr credential show --name acrtelemetrydevaj>" -ForegroundColor White
